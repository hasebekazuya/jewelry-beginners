        ...
        <div class="row">
            ...
            <h3 class="content_subtitle">ジュエリーとアクセサリーの違い</h3>
                <dl>
                    ...
                    <br/>
                    <dt class="mini_content" data-en="Precious metal">ジュエリー用の貴金属とは？</dt>
                        <dd>
                    ...
                    <br/>
                    <dt class="mini_content" data-en="Summary">まとめ</dt>
                        <dd>
                            ...
                            長く使用する結婚指輪や、大切な方への贈り物にはアクセサリーではなく、ジュエリーが適していると思われます。<br/>
                        </dd>
                        <br/>
                </dl>
            <h3 class="content_subtitle">モース硬度について</h3>
                <dl>
                    <dt class="mini_content" data-en="Mohs hardness">モース硬度とは？</dt>
                        <dd>
                        ...
                        <br/>
                    <dt class="mini_content" data-en="Hardness">硬さについて</dt>
                        <dd>
                            ...
                            ちなみに爪のモース硬度は約2.5なので、爪で引っ掻いて削れる鉱物はモース硬度2.5以下と判断することができます。<br/>
                        </dd>
                        <br/>
                </dl> 
                <div class="image">
            ...
            <h3 class="content_subtitle">金属の種類</h3>
                <dl>
                    <dt class="mini_content" data-en="Platinum">プラチナ</dt>
                        <dd>
                            ...
                            そのためプラチナジュエリーの割金が少なければ少ないほど、アレルギーが起こる確率も低くなります。<br/>
                        </dd>
                        <br/>
                    <dt class="mini_content" data-en="Gold">金</dt>
                        <dd>
                            ...
                            プラチナとよく混同されるホワイトゴールドは、純金に銀やニッケル、パラジウムを混ぜ合わせた合金で、プラチナとは違います。<br/>
                        </dd>
                        <br/>
                    <dt class="mini_content" data-en="Silver">銀</dt>
                        <dd>
                            ...
                            前者は銀色が長続きし、後者は徐々に黒くなります。<br/>
                        </dd>    
                </dl>
                <h3 class="content_subtitle">カラーゴールドの主な種類5つ</h3>
                <br/>
                ...
                <dt class="mini_content" data-en="Yellow">1.イエローゴールド</dt>
                    <dd>
                        イエローゴールドは、金に含まれる銀と銅の割合がほぼ同じです。純金の色味からやや薄くなることにより肌に馴染みやすく、身に着けやすいゴールドカラーとなります。ワンポイントとしてイエローゴールドを飾り付けると、豪華さと上品さを両立できます。ネックレスやピアスなど、特に顔周りを引き立てるようなアクセサリーにおすすめです。<br/>
                        色調の明るいイエローゴールドが、表情を明るく演出してくれます。<br/>
                    </dd>
                 <dt class="mini_content" data-en="Green">2.グリーンゴールド</dt>
                    <dd>
                        グリーンゴールドの色味は、銀や銅を主成分として作られます。素材の強度が低く、加工が非常に困難であるため、装飾品としての流通は多くありません。もし、グリーンゴールドを使用するとしても、変形に注意して丁寧な扱いを心がけましょう。<br/>
                        グリーンゴールドの緑がかった色合いは珍しく、個性的なアクセサリーを好む人におすすめです。</dt>
                    </dd>
                <dt class="mini_content" data-en="White">3.ホワイトゴールド</dt>
                    <dd>
                        ホワイトゴールドの白い色味は、パラジウム・銀・銅を配合して作られています。白い貴金属として高い価値のあるプラチナの代用品として使われ始めた歴史があり、現在ではプラチナと並ぶ人気の素材となりました。<br/>
                ...
                <dt class="mini_content" data-en="Pink">4.ピンクゴールド</dt>
                    <dd>
                        金をベースに銅の含有量を増やし、銀とパラジウムで調整すると、ピンクゴールドの美しい色合いが完成します。銅の割合が多く赤みの濃いものほど、硬く加工が難しい傾向にあり、サイズ直しなどの再加工が困難です。<br/>
                        パラジウムの割合が増えることで赤みが薄まり、柔らかく加工しやすい状態となります。ピンクベージュとも呼ばれる柔らかく上品な色合いは、腕時計やブレスレットとしても人気があります。淡く優しい雰囲気に見せたい場合に、ピンクゴールドはおすすめです。</p>
                    </dd>
                <dt class="mini_content" data-en="Red">5.レッドゴールド</dt>
                    <dd>
                        レッドゴールドは、銅を配合して赤みがかった金色を作り出しています。銅の比率が高くなることで硬度が増し、ピンクゴールドよりさらに加工が困難であることから、装飾品としては流通がほとんど見られません。<br/>
                        銅が酸化することで変色が進みやすい点がデメリットで、定期的な手入れが欠かせない素材です。ピンクゴールドよりさらにクリアな赤みが見られることから、肌の色に左右されずにピンクの色味を楽しめる点が魅力と言えます。</p>
                    </dd>
                <dt class="mini_content" data-en="Summary">まとめ</dt>    
                    <dd>
                        地金には金・銀・プラチナ類を使用し、天然・人口の宝石素材のみ使用したものをジュエリーと呼び。<br/>
