    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h3 class="content_subtitle">金属の種類</h3>
                ...
                <h2 class="content_subtitle">カラーゴールドの主な種類5つ</h2>
                <br/>
                ...
                <h3 class="mini_content" data-en="Yellow">1.イエローゴールド</h3>
                        <p>イエローゴールドは、金に含まれる銀と銅の割合がほぼ同じです。純金の色味からやや薄くなることにより肌に馴染みやすく、身に着けやすいゴールドカラーとなります。ワンポイントとしてイエローゴールドを飾り付けると、豪華さと上品さを両立できます。ネックレスやピアスなど、特に顔周りを引き立てるようなアクセサリーにおすすめです。
                        色調の明るいイエローゴールドが、表情を明るく演出してくれます。</p>
                    <br/>
                 <h3 class="mini_content" data-en="Green">2.グリーンゴールド</h3>
                ...
                <br/>
                <h3 class="mini_content" data-en="White">3.ホワイトゴールド</h3>
                ...
                <br/>
                <h3 class="mini_content" data-en="Pink">4.ピンクゴールド</h3>
                ...
                <br/>
                <h3 class="mini_content" data-en="Red">5.レッドゴールド</h3>
                ...
                <br/>
                <h3 class="mini_content" data-en="Summary">まとめ</h3>    
